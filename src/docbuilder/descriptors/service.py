...
""" Includes mock json values, ideally should be generated from object type
    and not hard coded by attribute name like here.
"""
MOCK_DATA = {
    "id": "1",
    ...
    "non_editable": "false",
    "access_control_list": """[{{}}]""", #TODO How to do multlne?
    "custom_attribute_values": """[{{}}]""", #TODO How to do multlne?
    "custom_attributes": """[{{}}]""", #TODO How to do multlne?
    "custom_attribute_definitions": """[{{}}]""", #TODO How to do multlne?
